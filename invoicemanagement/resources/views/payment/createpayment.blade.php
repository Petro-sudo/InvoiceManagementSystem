            ...
            <div class="card-body">
                <form action="{{route('store_payment')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="paymentreceiver" placeholder="Enter Name and Surname of Payment Receiver" name="paymentreceiver">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="paidamount" placeholder="Enter Order Amount Paid (R0.00)" name="paidamount">
                        <span class="text-danger">@error('paidamount'){{$message}}@enderror</span>
                    </div>

                    <div class="form-group">
                        <label for="paidwithin30days">Amount Paid Within 30 Day</label>
                        <input type="checkbox" class="form-check-input" id="paidwithin30days" name="paidwithin30days" value="Paid">

                    </div>

                    <div class="form-group">
                        <label for="paymentComments">Comment</label>
                        <textarea type="text" class="form-control " id="paymentComments" name="paymentComments"></textarea>
                    </div>
