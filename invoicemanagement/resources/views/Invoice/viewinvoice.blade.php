    ...
    <div class="container">
        ...
        <div class="body-section">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <p class="sub-heading">{{ $data2->paymentnumber }} </p>
                    <p class="sub-heading">{{ $data2->paydate }} </p>
                    <p class="sub-heading">{{ $data2->paidwithin30days }} </p>
                    <p class="sub-heading">{{ $data2->authorizedby }}</p>
                </div>
            </div>
            @endforeach
        </div>
