    ...
    dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                WELCOME TO THE INVOICE MANAGEMENT SYSTEM </p>
            </div>
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white"><img src="image/dotleft.jpg" alt="Cinque Terre" width="170" height="110"></h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm     leading-relaxed">
                                Welcome to Deptament Of Transport <svg viewBox="0 0 200 200" width="50" height="50" xmlns="http:www.w3.org/2000/svg">
                    ...
                    <a class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white"><img src="image/ndpright.png" alt="Cinque Terre" width="120" height="120"></h2>

                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">
                                <?php echo date("Y"); ?></h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm     leading-relaxed">
                                Welcome to our Invoice ManagementSystem, this is the system were you will be using when
                                capturing
                                incoming invoices, orders and payments from supply chain. In order to access this system
                                you need to login the admin will have to create them.
                            </p>
                        </div>
                    </a>
                </div>
