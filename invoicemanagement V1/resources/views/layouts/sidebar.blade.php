<!-- Sidebar Menu -->
<div class="sidenav">
    <!-- <div :class="{ '!translate-x-0': open }" id="navbarNavDropdown"
    ...
    <div class="p-1 text-center">
        <p class="mb-2 text-2xl font-bold whitespace-nowrap text-gray-800">
            Invoice Management
        </p>
        <span>{{Auth::user()->name}}
    ...
    <div class="flex flex-col mb-0 ml-0">
        ...
        <x-sidebar-nav-link :href="route('view_orders')">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<div :class="{ '!inline': open }" class="z-10 fixed top-0 left-0 w-screen h-screen bg-gray-900 bg-opacity-30 hidden md:!hidden transition ease-in-out duration-300">
</div>