            ...
            <div class="card-body">
                <form action="{{route('store_payment')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="paymentnumber" placeholder="Enter Payment Number" name="paymentnumber">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group form-check">
                            <input type="checkbox" class="form-check-input" id="paidwithin30days" name="paidwithin30days" value="Yes">
                            <label class="form-check-label" for="checkbox">Yes</label>
                        </div>

                        <div class="form-group form-check">
                            <input type="checkbox" class="form-check-input" id="paidwithin30days" name="paidwithin30days" value="No">
